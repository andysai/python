"""
Pattern(模式)属性
    创建对齐对象:pattern=xlwt.Pattern()
        pattern.pattern = xlwt.Pattern.SOLID_PATTERN # 设置模式
        pattern.pattern_fore_colour = 3 # 设置颜色，参考素材库中的颜色值.jpg或者是使用列表xlwt.Style.colour_map
"""
# 导入读写模块
import xlrd
import xlwt
...
# 保存
new_workbook.save('../source_material/2019年某公司新资表(6).xls')